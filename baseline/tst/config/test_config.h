 ...
 ************************************************/
#define NVM_ARRAY_SIZE     20000
#define CTE_INFO_ARRAY_SIZE 32
#define NVM_LOGGING__BYTE_SIZE 20000
#define GENERIC_LOG_ARRAY_SIZE      1000

extern t_uint32            VaAPI_Cmp_NVMRegion[NVM_ARRAY_SIZE];
extern t_uint32            VaAPI_Cmp_NVMLoggingRegion[NVM_LOGGING__BYTE_SIZE];
