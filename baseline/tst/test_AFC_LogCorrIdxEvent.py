...
data_ptr = ffi.cast("unsigned char *", ele_addr)
        ...
        param(
            {
                ...
                "Expected": {
                    ...
                    "cycle_count": 2,
                    "stage": 5,
                    "expected_temp": [-3377, -3377, -3377, -3377, -3377],
                },
            },
        ...
        param(
            {
                ...
                "Expected": {
                    "expected_indexes": [0,3,9,1,8],
                    "corr_incr_val": 0,
                    "cycle_count": 10,
                    "stage": 14,
                    "expected_temp": [-14377, -14377, -14377, -14377, -14377],
                },
            },
        ...
        param(
            {
                ...
                "Expected": {
                    "expected_indexes": [1,3,5,7,8],
                    "corr_incr_val": 1,
                    "cycle_count": 100,
                    "stage": 14,
                    "expected_temp": [-5377, -5377, -5377, -5377, -5377],
                },
            },
        ...
        param(
            {
                ...
                "Expected": {
                    "expected_indexes": [3,2,4,8,9],
                    "corr_incr_val": 1,
                    "cycle_count": 110,
                    "stage": 0,
                    "expected_temp": [2300, 2300, 2300, 2300, 2300],
                },
            },
...
def test_AFC_LogCorrIdxEvent_log_events(lib, setup_parameters, test_cases) -> None:
    ...
    try:
        ...
        lib.test_cell_ids = ffi.new("unsigned short[5]")
        for i in range(5):
            lib.test_cell_ids[i] = cell_ids[i]
        # logging event call method AFC_LogCorrIdxEvent

        lib.AFC_LogCorrIdxEvent(list(lib.test_cell_ids))
