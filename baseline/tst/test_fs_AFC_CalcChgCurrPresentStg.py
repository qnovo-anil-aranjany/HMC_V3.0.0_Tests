"""Test Module Description:
    Test module for 'fs_AFC_CalcChgCurrPresentStg' function in the fast charging algorithm.

    This test group contains pytest test cases designed to ensure that the 'fs_AFC_CalcChgCurrPresentStg'
...
def test_fs_AFC_CalcChgCurrPresentStg(lib, setup_parameters, test_cases) -> None:
    """
    This test function performs verification of specific operating conditions relevant to the
    'fs_AFC_CalcChgCurrPresentStg' function.
    """
    ...
    # Run Function
    # ------------------------------------------------
    Le_I_Stg_ChgCurr = lib.fs_AFC_CalcChgCurrPresentStg(Le_i_PresentStageIdx)
...
if RUN_STACK_PARAM_TESTS:
    ...
    def test_fs_AFC_CalcChgCurrPresentStg_coverage(
