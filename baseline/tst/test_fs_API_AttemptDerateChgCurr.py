"""Test Module Description:
    Test module for 'fs_API_AttemptDerateChgCurr' function in the fast charging algorithm.

    This test group contains pytest test cases designed to ensure that the 'fs_API_AttemptDerateChgCurr'
...
@pytest.mark.parametrize(
    ...
    [
        param(
            ...
            id="TC1_NoDerate_MinTemperature",
            marks=[
                mark.description(
                    "This test case verifies that the current has not derated yet since the max temperature is at "
                    "-20.0°C."
                ),
        ...
        param(
            ...
            id="TC2_NoDerate_BeforeStartTemp",
            marks=[
                mark.description(
                    "This test case verifies that the current has not derated yet since the max temperature is at "
                    "47.9°C."
        ...
        param(
            {
                "Inputs": {
                    "VeAPI_T_MaxTempSnsr": 485,
                    "VeAFC_I_ChgPackCurr": 331600,
                },
                "Expected": {
                    "VeAFC_I_ChgPackCurr": 330245,
                },
            },
            id="TC3_StartDerate",
            marks=[
                mark.description(
                    "This test case verifies that the current derates starting at 48.0°C."
                ),
                mark.jira_id("QAFC-51"),
            ],
        ),
        param(
            {
                "Inputs": {
                    "VeAPI_T_MaxTempSnsr": 550,
                    "VeAFC_I_ChgPackCurr": 331600,
                },
                "Expected": {
                    "VeAFC_I_ChgPackCurr": 199021,
                },
            },
            id="TC4_Derate_55.0degC",
            marks=[
                mark.description(
                    "This test case verifies the derated current value at 55.0°C."
                ),
                mark.jira_id("QAFC-51"),
            ],
        ),
        param(
            {
                "Inputs": {
                    "VeAPI_T_MaxTempSnsr": 569,
                    "VeAFC_I_ChgPackCurr": 331600,
                },
                "Expected": {
                    "VeAFC_I_ChgPackCurr": 69749,
                },
            },
            id="TC5_Derate_BeforeEndTemp",
            marks=[
                mark.description(
                    "This test case verifies the derated current value at 56.9°C."
                ),
                mark.jira_id("QAFC-51"),
            ],
        ),
        param(
            ...
            marks=[
                mark.description(
                    "This test case verifies the derated current value at 57.0°C."
                ),
                mark.jira_id("QAFC-51"),
            ],
        ),
        param(
            ...
            id="TC7_DerateToZero_Exceed_EndTemp",
            marks=[
                mark.description(
                    "This test case verifies the derated current value at any temperature above 57.0°C."
                ),
                mark.jira_id("QAFC-51"),
            ],
        ),
        param(
            {
                ...
                "Expected": {
                    "VeAFC_I_ChgPackCurr": 103238,
                },
            },
            id="TC8_Derate_55.0degC_MinSOC",
            marks=[
                mark.description(
                    "This test case verifies the derated current value at 55.0°C."
                ),
        ...
        param(
            {
                ...
                "Expected": {
                    "VeAFC_I_ChgPackCurr": 266436,
                },
            },
            id="TC9_Derate_55.0degC_MaxSOC",
            marks=[
                mark.description(
                    "This test case verifies the derated current value at 55.0°C."
                ),
        ...
        param(
            {
                "Inputs": {
                    "VeAPI_Pct_PackSOC": 7002,
                    "VeAPI_T_MaxTempSnsr": 569,
                    "VeAFC_I_ChgPackCurr": 331600,
                },
                "Expected": {
                    "VeAFC_I_ChgPackCurr": 169996,
                },
            },
            id="TC11_Derate_Above70%SOC",
            marks=[
                mark.description(
                    "This test case verifies the derated current value at 55.0°C."
                ),
        ...
        param(
            {
                ...
                "Expected": {
                    "VeAFC_I_ChgPackCurr": 9401,
                },
            },
            id="TC12_Derate_at0.1%SOC",
            marks=[
                mark.description(
                    "This test case verifies the derated current value at 55.0°C."
                ),
...
def test_fs_API_AttemptDerateChgCurr(lib, setup_parameters, test_cases) -> None:
    """
    This test function performs verification of specific operating conditions relevant to the
    'fs_API_AttemptDerateChgCurr' function.
    """
