...
def setup_parameters(lib) -> None:
    ...
    lib.AFC_VM_VoltageImbalance.Va_U_SE_ChargeVoltageSums = [0] * size(lib.AFC_VM_VoltageImbalance.Va_U_SE_ChargeVoltageSums)
    lib.AFC_VM_VoltageImbalance.Va_U_SE_ChargeVoltageSums_Sort = [0] * size(lib.AFC_VM_VoltageImbalance.Va_U_SE_ChargeVoltageSums_Sort)
    lib.AFC_VM_VoltageImbalance.Ve_Cnt_ExecutionCounter = 0
    lib.AFC_VM_VoltageImbalance.Ve_t_SamplingTime = 0
    lib.AFC_VM_VoltageImbalance.Va_U_SE_AbsoluteVoltageSumDeviations = [0] * size(lib.AFC_VM_VoltageImbalance.Va_U_SE_AbsoluteVoltageSumDeviations)
    lib.AFC_VM_VoltageImbalance.Ve_b_ReadyForAnalysis = 0
    lib.AFC_VM_VoltageImbalance.Va_b_VoltageImbalanceFlags = [0] * size(lib.AFC_VM_VoltageImbalance.Va_b_VoltageImbalanceFlags)
...
def process_log_buffer(lib, extn=1, write_to_file=False):
    ...
    for i in range(extn):
        ...
        ele_addr = ffi.new("unsigned char[18]")
