        ...
        param(
            {
                ...
                "Expected": {
                    "expected_indexes": [73, 3, 23, 100, 189],
                    "corr_incr_val": 1,
                    "cycle_count": 0,
                    "stage": 1,
                    "expected_temp": [1, -32768, -13108, 13107, -4377],
                    "expected_warnings": [],
                    "nvm_warnings": [],
                    "highest_index": 0,
                },
...
def test_AFC_LogCorrIdxEvent_check_aging(lib, setup_parameters, test_cases) -> None:
    ...
    try:
        ...
        #lib.test_cell_ids = ffi.new("uint16_t[]", cell_ids)
...
@pytest.mark.parametrize(
    ...
    [
        param(
            {
                "Inputs": {
                    "VaAPI_U_CellVolts": [np.uint16(0) for _ in range(192)],
                    "ele_addr": data_ptr,
                    "corr_incr_val": 1,
                    "test_cell_values": [
                        [73, 4300, 1],
...
def Atest_AFC_LogCorrIdxEvent_check_aging_1(lib, setup_parameters, test_cases) -> None:
    """
    Verify logging of cell aging events correctly into the log buffer.
    """
    try:
