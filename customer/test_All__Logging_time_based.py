        ...
        for i in range(1):
            ...
            for j in range(1):
                ...
                for each_time_step in all_time_steps:
                    # This is specific to test input file data.
                    if row_count == 918:
                        lib.Qnovo_AFC_Init()
                    ...
                    while True:
                        ...
                        if lib.Output_SlicingStatus == 0:
                            ...
                            break
                        slice_count += 1
                    #print(f"\n Current Charge Cycle for row :{row_count} is : {lib.s_AFC_Track.Ne_Cnt_ChargeCycleNum}\n")

                    if lib.Output_SlicingStatus != 0:
                        pytest.fail("Output Ready Flag not 1")
                        continue
