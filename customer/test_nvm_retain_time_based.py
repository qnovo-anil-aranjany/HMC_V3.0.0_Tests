...
MAKE_HTML = True
if not SKIP_TEST:
    _FILENAME = "Behavioral_Test_logging_nvm_retain.xlsx"
        ...
        for i in range(1):
            ...
            for k in range(1):
                for each_time_step in all_time_steps:
                    if row_count == 765:
                        lib.Qnovo_AFC_Init()
                        print(f"\nQnovo_AFC_Init called for row: {row_count} stating new row_counts")
                        new_cycle = True
                        row_count = 2
                    ...
                    results["Mitigated_Current"].append(lib.VeAFC_I_MitigatedCurr)
                ...
                if count > 0:
                    ...
                    count = 0
                    final_output = []
                print(f"Current Cycle : {lib.s_AFC_Track.Ne_Cnt_ChargeCycleNum}")
