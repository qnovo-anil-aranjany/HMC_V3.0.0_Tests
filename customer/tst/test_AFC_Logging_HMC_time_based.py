            ...
            for each_time_step in all_time_steps:
                ...
                if previous_Na_Cnt_HighestCPVCorrIdx != list(
                    ...
                    if log_buffer_elements_count <= prev_log_buffer_elements_count:
                        ...
                        print(f"log_buffer_elements_count: {log_buffer_elements_count}")
                        print(f"previous_Na_Cnt_HighestCPVCorrIdx: {previous_Na_Cnt_HighestCPVCorrIdx} and current : {list(lib.s_AFC_Track.NaAFC_Cnt_HighestCPVCorrIdx)}")
                        assert (
